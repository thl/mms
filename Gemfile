...
gem 'attachment_fu_patch',        '2.1.4',        git: 'http://github.com/thl/attachment_fu_patch',         tag: 'v2.1.4' #path: '../engines/attachment_fu_patch'
...
gem 'dictionary_integration',     '2.1.5',        git: 'http://github.com/thl/dictionary_integration',      tag: 'v2.1.5' #path: '../engines/dictionary_integration'
gem 'interface_utils',            '2.1.15',       git: 'http://github.com/thl/interface_utils',             tag: 'v2.1.15' #path: '../../../thl-legacy/thl/engines/interface_utils'
