...
gem 'comatose',                   '2.0.9',        :git => 'git://github.com/niciliketo/comatose.git'
...
gem 'attachment_fu_patch',        '2.1.0',        :git => 'git://github.com/thl/attachment_fu_patch.git',        :tag => 'v2.1.0' #:path => '../engines/attachment_fu_patch'
...
gem 'mms_engine',                 '2.7.3',        :git => 'git://github.com/thl/mms_engine.git',                 :tag => 'v2.7.3' #:path => '../engines/mms_engine'
gem 'places_integration',         '2.1.0',        :git => 'git://github.com/thl/places_integration.git',         :tag => 'v2.1.0' #:path => '../engines/places_integration'
