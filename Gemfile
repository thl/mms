...
gem 'active_resource_extensions', '2.1.6',        github: 'thl/active_resource_extensions',  tag: 'v2.1.6' #path: '../engines/active_resource_extensions'
...
gem 'mms_engine',                 '2.9.5',        github: 'thl/mms_engine',                  tag: 'v2.9.5' #path: '../engines/mms_engine'
