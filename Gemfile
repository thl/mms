...
gem 'interface_utils',            '2.1.13',       github: 'thl/interface_utils',             tag: 'v2.1.13' #path: '../../../thl-legacy/thl/engines/interface_utils'
...
gem 'mms_engine',                 '3.2.6',        github: 'thl/mms_engine',                  tag: 'v3.2.6' #path: '../engines/mms_engine'
