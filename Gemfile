...
gem 'kmaps_integration',          '2.0.1', :git => 'git://github.com/thl/kmaps_integration.git', :tag => 'v2.0.1'             #:path => '../engines/kmaps_integration'
gem 'mms_engine',                 '2.0.1', :git => 'git://github.com/thl/mms_engine.git', :tag => 'v2.0.1'                    #:path => '../engines/mms_engine'
