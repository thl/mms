...
gem 'spawn',                      '2.0.0', :git => 'git://github.com/tra/spawn.git'
...
gem 'authenticated_system',       '2.0.6', :git => 'git://github.com/thl/authenticated_system.git',       :tag => 'v2.0.6' #:path => '../engines/authenticated_system'
...
gem 'kmaps_integration',          '2.0.2', :git => 'git://github.com/thl/kmaps_integration.git',          :tag => 'v2.0.2' #:path => '../engines/kmaps_integration'
gem 'mms_engine',                 '2.0.2', :git => 'git://github.com/thl/mms_engine.git',                 :tag => 'v2.0.2' #:path => '../engines/mms_engine'
gem 'attachment_fu_patch',        '2.0.0', :git => 'git://github.com/thl/attachment_fu_patch.git',        :tag => 'v2.0.0' #:path => '../engines/attachment_fu_patch'
