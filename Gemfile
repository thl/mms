...
gem 'flare',                      '0.0.1',        github: 'shanti-uva/flare',                tag: 'v0.0.1' #path: '../../shanti/engines/flare'
#gem 'topical_map_integration',    '3.1.0',        :github: 'thl/topical_map_integration',    tag: 'v3.1.0' #path: '../engines/topical_map_integration'
gem 'mms_engine',                 '3.0.8',        github: 'thl/mms_engine',                  tag: 'v3.0.8' #path: '../engines/mms_engine'
