...
gem 'active_resource_extensions', '2.2.4',        github: 'thl/active_resource_extensions',  tag: 'v2.2.4' #path: '../engines/active_resource_extensions'
gem 'attachment_fu_patch',        '2.1.4',        github: 'thl/attachment_fu_patch',         tag: 'v2.1.4' #path: '../engines/attachment_fu_patch'
gem 'authenticated_system',       '2.4.0',        github: 'thl/authenticated_system',        tag: 'v2.4.0' #path: '../engines/authenticated_system'
gem 'complex_scripts',            '2.3.1',        github: 'thl/complex_scripts',             tag: 'v2.3.1' #path: '../engines/complex_scripts'
gem 'dictionary_integration',     '2.1.4',        github: 'thl/dictionary_integration',      tag: 'v2.1.4' #path: '../engines/dictionary_integration'
gem 'interface_utils',            '2.1.14',       github: 'thl/interface_utils',             tag: 'v2.1.14' #path: '../../../thl-legacy/thl/engines/interface_utils'
...
gem 'mms_engine',                 '3.2.7',        github: 'thl/mms_engine',                  tag: 'v3.2.7' #path: '../engines/mms_engine'
...
gem 'thl_integration',            '2.2.7',        github: 'thl/thl_integration',             tag: 'v2.2.7' #path: '../engines/thl_integration'
