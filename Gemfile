...
gem 'attachment_fu_patch',        '2.0.3',        :git => 'git://github.com/thl/attachment_fu_patch.git',        :tag => 'v2.0.3' #:path => '../engines/attachment_fu_patch'
...
gem 'mms_engine',                 '2.3.6',        :git => 'git://github.com/thl/mms_engine.git',                 :tag => 'v2.3.6' #:path => '../engines/mms_engine'
